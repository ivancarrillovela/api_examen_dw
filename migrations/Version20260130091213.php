 ...
 */
final class Version20260130091213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, max_participants INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
